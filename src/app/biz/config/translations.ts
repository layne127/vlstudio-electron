...
export default {
  ...
  'The follow up date as an EL expression (e.g. ${someDate} or an ISO date (e.g. --T::)':
    '跟踪日期必须符合EL表达式，如： ${someDate} ,或者一个ISO标准日期，如：--T::',
  'The due date as an EL expression (e.g. ${someDate} or an ISO date (e.g. --T::)':
    '跟踪日期必须符合EL表达式，如： ${someDate} ,或者一个ISO标准日期，如：--T::',
  Variables: '变量', */
