{
    ...
    xeogl.AxisHelper = function (cfg) {
        ...
        div.innerHTML += '<canvas id="' + canvasId + '" style="width: ' + size[0] + 'px; height: ' + size[1] + 'px; float: left; margin: 0; padding: 0;pointer-events:none;"></canvas>';
        canvas.canvas.parentElement.appendChild(div);
